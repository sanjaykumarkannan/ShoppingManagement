...
public class ShoppingQueries {
	...
	public static String GET_ALL_FILES=new String("select * from products where useremail=?");
	public static String UPDATE_USER=new String ("update users set name=?,dob=? where id=?");
	public static String DELETE_USER="delete from products where productid=?";
